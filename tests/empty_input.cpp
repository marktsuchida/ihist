    ...
    SECTION("2d") {
        SECTION("empty-data") {
            SECTION("mono") {
                ...
                histxy_func(nullptr, nullptr, 0, 0, 0, 0, 0, 0, hist.data(),
                            1);
                CHECK(hist == expected);
            }
            SECTION("multi") {
                ...
                histxy_func(nullptr, nullptr, 0, 0, 0, 0, 0, 0, hist3.data(),
                            1);
                CHECK(hist3 == expected3);
            }
        }
        ...
        SECTION("empty-roi") {
            SECTION("mono") {
                constexpr auto *histxy_func =
                    traits::template histxy_func<false, BITS, 0, 1, 0>;
                std::vector<T> data(6);
                histxy_func(data.data(), nullptr, 3, 2, 1, 1, 0, 0,
                            hist.data(), 1);
                CHECK(hist == expected);
            }
            SECTION("multi") {
    ...
    SECTION("2d-mask") {
        ...
        SECTION("empty-roi") {
            SECTION("mono") {
                ...
                histxy_func(data.data(), mask.data(), 3, 2, 1, 1, 0, 0,
                            hist.data(), 1);
                CHECK(hist == expected);
            }
            SECTION("multi") {
        ...
        SECTION("empty-mask") {
            SECTION("mono") {
                ...
                histxy_func(data.data(), mask.data(), 3, 2, 0, 0, 3, 2,
                            hist.data(), 1);
                CHECK(hist == expected);
            }
            SECTION("multi") {
