...
#define IHIST_TMPL_INST_BOTHD(Extern, mt, T, mask, bits, stripes, unrolls,    \
                              stride, ...)                                    \
    Extern IHIST_TMPL_INST_1D(mt, T, mask, bits, stripes, unrolls, stride,    \
                              __VA_ARGS__)                                    \
    Extern IHIST_TMPL_INST_2D(mt, T, mask, bits, stripes, unrolls, stride,    \
                              __VA_ARGS__)

#define IHIST_TMPL_INST_MT(Extern, T, mask, bits, stripes, unrolls, stride,   \
                           ...)                                               \
...
#define IHIST_TMPL_INST_BITS(Extern, mask, stripes, unrolls, stride, ...)     \
...
#define IHIST_TMPL_INST_MASK(Extern, stripes, unrolls, stride, ...)           \
    IHIST_TMPL_INST_BITS(Extern, false, stripes, unrolls, stride,             \
                         __VA_ARGS__)                                         \
    IHIST_TMPL_INST_BITS(Extern, true, stripes, unrolls, stride, __VA_ARGS__)

#define IHIST_TMPL_INST_STRIPES(Extern, unrolls, stride, ...)                 \
    IHIST_TMPL_INST_MASK(Extern, 1, unrolls, stride, __VA_ARGS__)             \
    IHIST_TMPL_INST_MASK(Extern, 2, unrolls, stride, __VA_ARGS__)             \
    IHIST_TMPL_INST_MASK(Extern, 4, unrolls, stride, __VA_ARGS__)             \
    IHIST_TMPL_INST_MASK(Extern, 8, unrolls, stride, __VA_ARGS__)             \
    IHIST_TMPL_INST_MASK(Extern, 16, unrolls, stride, __VA_ARGS__)
