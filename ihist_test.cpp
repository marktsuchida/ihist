...
TEMPLATE_TEST_CASE("empty-data", "", std::uint8_t, std::uint16_t) {
    auto const hist_func =
        GENERATE(hist_unfiltered_naive_st<TestType>,
                 ...
                 hist_unfiltered_batchstriped_st<0, TestType>,
                 hist_unfiltered_batchstriped_st<1, TestType>,
                 hist_unfiltered_batchstriped_st<2, TestType>,
                 ...
                 hist_unfiltered_batchstriped_mt<0, TestType>,
                 hist_unfiltered_batchstriped_mt<1, TestType>,
                 hist_unfiltered_batchstriped_mt<2, TestType>);
...
TEMPLATE_TEST_CASE("const-data-himask-discard-low", "", std::uint8_t,
    ...
    auto const hist_func =
        GENERATE(hist_himask_naive<TestType, BITS, LO_BIT>,
                 ...
                 hist_himask_batchstriped_st<0, TestType, BITS, LO_BIT>,
                 hist_himask_batchstriped_st<1, TestType, BITS, LO_BIT>,
                 hist_himask_batchstriped_st<2, TestType, BITS, LO_BIT>,
                 ...
                 hist_himask_batchstriped_mt<0, TestType, BITS, LO_BIT>,
                 hist_himask_batchstriped_mt<1, TestType, BITS, LO_BIT>,
                 hist_himask_batchstriped_mt<2, TestType, BITS, LO_BIT>);
...
TEMPLATE_TEST_CASE("random-data-clean-filtered", "", std::uint8_t,
    ...
    auto hist_func =
        GENERATE(hist_filtered_naive_st<TestType, BITS>,
                 hist_filtered_striped_st<2, TestType, BITS>,
                 hist_filtered_batchstriped_st<2, TestType, BITS>,
                 hist_filtered_naive_mt<TestType, BITS>,
                 hist_filtered_striped_mt<2, TestType, BITS>,
                 hist_filtered_batchstriped_mt<2, TestType, BITS>);
