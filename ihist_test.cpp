...
TEMPLATE_TEST_CASE("empty-data", "", std::uint8_t, std::uint16_t) {
    auto const hist_func = GENERATE(
        ...
        hist_unfiltered_radixpartition<6, TestType>,
        hist_unfiltered_radixmultipass<6, TestType>,
...
TEMPLATE_TEST_CASE("random-data", "", std::uint8_t, std::uint16_t) {
    auto const hist_func = GENERATE(
        ...
        hist_unfiltered_radixpartition<6, TestType>,
        hist_unfiltered_radixmultipass<6, TestType>,
        internal::hist_chunked<hist_unfiltered_radixpartition<6, TestType>,
                               TestType>,
        internal::hist_chunked<hist_unfiltered_radixmultipass<6, TestType>,
                               TestType>,
        hist_unfiltered_naive_mt<TestType>,
        hist_unfiltered_striped_mt<0, TestType>,
        hist_unfiltered_striped_mt<1, TestType>,
...
TEMPLATE_TEST_CASE("random-data-clean-discard-low", "", std::uint8_t,
    ...
    auto hist_func = GENERATE(
        ...
        hist_unfiltered_radixmultipass<BITS / 2, TestType, BITS, LO_BIT>,
        hist_unfiltered_radixpartition<BITS / 2, TestType, BITS, LO_BIT>,
